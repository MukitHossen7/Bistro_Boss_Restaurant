...
const AdminHome = () => {
  ...
  const { data: stats = {} } = useQuery({
    queryKey: ["adminHome"],
    queryFn: async () => {
      const { data } = await axiosInstance(`/count`);
      return data;
    },
  });
  console.log(stats);
  return (
    <div>
      <h3 className="text-4xl font-semibold">welcome to Admin Home</h3>
      <div className="stats shadow mt-16 text-center">
        <div className="stat">
        ...
        <div className="stat">
          ...
          <div className="stat-title font-bold text-secondary">Orders</div>
